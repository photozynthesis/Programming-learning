...
public class HtmlBuilder {
    ...
    public static String buildMarkdownHtml(int curretLevel, String bodyHtml, String title) throws IOException {
        ...
        // 读取 part-1
        reader = new BufferedReader(new FileReader("src/main/resources/html-markdown/part-1.html"));
        ...
        // 拼接 part-2
        reader = new BufferedReader(new FileReader("src/main/resources/html-markdown/part-2.html"));
        while((temp = ((BufferedReader) reader).readLine()) != null) {
            sb.append(temp);
            sb.append("\n");
        }
        ...
        // 拼接 part-3
        reader = new BufferedReader(new FileReader("src/main/resources/html-markdown/part-3.html"));
        while((temp = ((BufferedReader) reader).readLine()) != null) {
            sb.append(temp);
            sb.append("\n");
        }
...
//    }
    ...
    public static String buildIndexHtml(File htmlFolder) throws IOException{
        ...
        // 拼接头部
        reader = new BufferedReader(new FileReader("src/main/resources/html-main/part-1.html"));
        while((temp = ((BufferedReader) reader).readLine()) != null) {
            sb.append(temp);
            sb.append("\n");
        }
        ...
        // 拼接尾部
        reader = new BufferedReader(new FileReader("src/main/resources/html-main/part-2.html"));
        while((temp = ((BufferedReader) reader).readLine()) != null) {
            sb.append(temp);
            sb.append("\n");
        }
